...
require_once('main.php'); //load framework with template

Page::Start('Template Example'); //title

h1('Main Content');
p('Each page has the same beginning, menu and end loaded from the template.');

section(true, ['id' => 'section1']);
h2('Section 1');
